          ...
          <View
            ...
            <Text
              style={{
                ...
                {cardQuery.data ? `${card.card_details?.amount} ${card.card_details?.currency}` : <ActivityIndicator />}
                {cardQuery.error && <TouchableOpacity onPress={() => cardQuery.revalidate()} style={{
                  backgroundColor: Colors.primary,
                  paddingVertical: 6,
                  paddingHorizontal: 16,
                  borderRadius: 12
                }}><Text style={{color: "white", fontFamily: "Inter-SemiBold"}}>Afficher</Text></TouchableOpacity>}
